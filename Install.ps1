<#
.SYNOPSIS
    One-click installer and launcher for Intune Device Cleanup Rule Automation
...
Write-Host "    Intune Device Cleanup Rule Automation" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/intune-device-cleanup-rule-automation.ps1"
